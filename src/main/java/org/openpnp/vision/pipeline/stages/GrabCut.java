...
import org.opencv.imgproc.Imgproc;
	...
	/**
	 * GrabCut algorithm was designed by Carsten Rother, Vladimir Kolmogorov & Andrew Blake from Microsoft Research Cambridge, 
	 * UK. in their paper, "GrabCut": interactive foreground extraction using iterated graph cuts . 
	...
	public class GrabCut extends CvStage {
	    ...
	    public Result process(CvPipeline pipeline) throws Exception {
	        ...
	        int r1 = mat.rows();
	        int c1 = mat.cols();
//	        int c1 = Math.max(getBackGroundOriginX(),getSideSquare());
//	        c1 = Math.min(c1,getSideSquare()-c/2);
//	        int r1 = Math.max(getBackGroundOriginY(),getSideSquare()+r/2);
//	        r1 = Math.min(r1,getSideSquare()-r/2);

	        Point p1 = new Point(getBackGroundOriginX()-getSideSquare(), getBackGroundOriginY()-getSideSquare());
	        Point p2 = new Point(getBackGroundOriginX()+getSideSquare(), getBackGroundOriginY()+getSideSquare());
...
//	        Core.rectangle(mat, p1, p2, color,3);
	        return null;
//	        
//
//
